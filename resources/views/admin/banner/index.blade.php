                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('banner.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Create Banner</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <img src="{{ asset($data->image) }}" alt="banner image" width="150" class="border p-1 rounded">
                                    </td>
                                    <td class="align-middle">
                                        <form action="{{ route('banner.destroy', $data->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                            <a href="{{ route('banner.edit', $data->id) }}" class="text-info"><i class="fas fa-edit"></i></a>
