                    ...
                    <form role="form" action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" maxlength="70" class="form-control" id="meta_title" placeholder="Enter sub category name" value="{{ old('meta_title') }}">
                            @error('meta_title')
                              <span class="text-danger">{{ $message }}</span>
                            @enderror
                          </div>
                          <div class="form-group">
                            ...
                            <textarea name="meta_description" id="meta_description" maxlength="170" rows="5" class="form-control" placeholder="Enter meta description">{{ old('meta_description') }}</textarea>
