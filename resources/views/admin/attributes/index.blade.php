                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('attributes.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Create Attributes</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('attributes.destroy', $data->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                            <a href="{{ route('attributes.edit', $data->id) }}" class="text-info"><i class="fas fa-edit"></i></a>
