                  ...
                  <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input name="phone" class="form-control" placeholder="Phone Number" type="number" minlength="11" maxlength="11">
                        </div>
                        @error('phone')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" placeholder="Repeat password" name="password_confirmation" type="password">
                        </div>
                    </div>
                    <div class="form-group">
